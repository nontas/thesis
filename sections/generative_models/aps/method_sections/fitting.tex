...
$\mathbf{Q}^a=\mathbf{I}-\mathbf{W}\mathbf{W}^{\mathsf{T}}$.
...
$\mathbf{Q}^a=\mathbf{W}\mathbf{D}^{-1}\mathbf{W}^{\mathsf{T}}+\frac{1}{\sigma^2}(\mathbf{I}-\mathbf{W}\mathbf{W}^{\mathsf{T}})$.
This precision matrix is derived by applying the Woodbury formula on the
covariance matrix
$\mathbf{W}\mathbf{D}\mathbf{W}^{\mathsf{T}}+\sigma^2\mathbf{I}$,
