...
with respect to the parameters of a statistical shape model. One of the major
contributions of this chapter is the proof that modeling the patch-based
appearance of an object with a GMRF structure is more beneficial than applying
a PCA model. APS also introduce a spring-like deformation prior term that makes
