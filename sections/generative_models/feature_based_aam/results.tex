...
that require multiple iterations until convergence. Note that it is not in the
...
in~\cite{tzimiropoulos2013optimization} and one could also use GPU or parallel
programming to achieve much faster performance and eliminate the cost difference
between various features and also between the two composition scenarios of
$\mathcal{F}$ and $\mathcal{W}$.
