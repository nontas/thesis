...
\begin{figure}[t]
  ...
  \textcolor{red}{\emph{The figure is taken from~\cite{tzimiropoulos2012subspace}.}}}
  \label{fig:baboon}
\end{figure}
%
...
\textcolor{red}{\st{an optimal} a} generative
...
\textcolor{red}{\mathbf{E}}
\end{aligned}
\label{equ:problem}
\end{equation}
%%%%%%%%%%%%%%
in order to find the \textcolor{red}{\st{optimal}} appearance subspace $\mathbf{U}_a$ and mean vector
...
$\mathbf{U}_a^{\mathsf{T}}\mathbf{U}_a=\textcolor{red}{\mathbf{E}}$. In this work, we
...
estimate of $\mathbf{p}^i$ and compute the \textcolor{red}{\st{optimal}} appearance parameters as the
