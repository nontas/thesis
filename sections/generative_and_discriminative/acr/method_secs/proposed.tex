...
the regression-based descent directions and the Gauss-Newton \textcolor{red}{\st{gradient}}
descent directions at each level of the cascade $k=1,\ldots,K$.
The negative sign in front of the \textcolor{red}{\st{gradient}Gauss-Newton} descent directions is
...
During training, ACR aims to learn a cascade of $K$ \textcolor{red}{\st{optimal}} linear regressors
given the \textcolor{red}{\st{gradient}Gauss-Newton} descent directions of each training image at each level.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{Step 3: \textcolor{red}{\st{Gradient}Gauss-Newton} Descent Directions} Compute the
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
{\color{red}
\paragraph{Weighting Hyperparameters}
...
regression and Gauss-Newton descent directions explained above and shown in Fig.~\ref{fig:motivation},
