...
the rest.
\textcolor{red}{\st{Intuitively, this means that the regression-based descent directions need to
...
Gauss-Newton descent steps are sufficient in order to converge to an accurate local
minimum.}}
