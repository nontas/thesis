...
=&\argmin_{\Delta\mathbf{p}} \left(\left[\mathcal{A}(\mathcal{S}(\bar{\mathbf{s}},\mathbf{p}))+\mathbf{J}_{\mathcal{A}}\Delta\mathbf{p}-\bar{\mathbf{a}}\right]^{\mathsf{T}} \mathbf{Q}^a \left[\mathcal{A}(\mathcal{S}(\bar{\mathbf{s}},\mathbf{p}))+\mathbf{J}_{\mathcal{A}}\Delta\mathbf{p}-\bar{\mathbf{a}}\right] + \left[\mathcal{S}(\mathbf{0},\mathbf{p})+\mathbf{J}_{\mathcal{S}}\Delta\mathbf{p}\right]^{\mathsf{T}} \mathbf{Q}^s \left[\mathcal{S}(\mathbf{0},\mathbf{p})+\mathbf{J}_{\mathcal{S}}\Delta\mathbf{p}\right]\right)
\end{aligned}
\end{equation}
%%%%%%%%%%%%%%
%
